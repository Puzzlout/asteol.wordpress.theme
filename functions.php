...
function twentyseventeen_scripts() {
	...
	//Asteol custom styles
	wp_enqueue_style( 'twentyseventeen-asteol-custom-style', get_theme_file_uri( '/assets/css/asteol.e494f82.css' ), array( 'twentyseventeen-style' ), '1.0' );
